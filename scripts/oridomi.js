...
(function () {
  ...
  OriDomi = (function () {
    function OriDomi(el, options) {
      ...
      (_ref = this.settings),
        (this.shading = _ref.shading),
        (this.shadingIntensity = _ref.shadingIntensity),
        (this.vPanels = _ref.vPanels),
        (this.hPanels = _ref.hPanels);
      ...
      for (_m = 0, _len4 = _ref3.length; _m < _len4; _m++) {
        anchor = _ref3[_m];
        for (
          i = _n = 0, _ref4 = this.hPanels;
          0 <= _ref4 ? _n < _ref4 : _n > _ref4;
          i = 0 <= _ref4 ? ++_n : --_n
        ) {
          ...
          if (anchor === "top") {
            ...
            yOffset = -(
              this.hPanels * this.panelHeight -
              this.panelHeight * (i + 1)
            );
            if (i === 0) {
              panel.style.top =
                this.panelHeight * (this.vPanels - 1) - bleed + "px";
            } else {
              panel.style.top = -this.panelHeight + "px";
            }
          }
          ...
          if (this.shading) {
            this.shaders[anchor].top[i] = panel.getElementsByClassName(
              "oridomi-shader-top"
            )[0];
            this.shaders[anchor].bottom[i] = panel.getElementsByClassName(
      ...
      for (_o = 0, _len5 = _ref5.length; _o < _len5; _o++) {
        anchor = _ref5[_o];
        for (
          i = _p = 0, _ref6 = this.vPanels;
          0 <= _ref6 ? _p < _ref6 : _p > _ref6;
          i = 0 <= _ref6 ? ++_p : --_p
        ) {
          ...
          if (anchor === "left") {
            ...
            xOffset = -(
              this.vPanels * this.panelWidth -
              this.panelWidth * (i + 1)
            );
            if (i === 0) {
              panel.style.left =
                this.panelWidth * (this.vPanels - 1) - 1 + "px";
            } else {
              panel.style.left = -this.panelWidth + "px";
            }
          }
          ...
          if (this.shading) {
            this.shaders[anchor].left[i] = panel.getElementsByClassName(
              "oridomi-shader-left"
            )[0];
            this.shaders[anchor].right[i] = panel.getElementsByClassName(
              "oridomi-shader-right"
            )[0];
          }
          this.panels[anchor][i] = panel;
          if (i !== 0) {
    ...
    OriDomi.prototype._callback = function (options) {
      ...
      if (typeof options.callback === "function") {
        ...
        if (this.lastAngle === 0) {
          ...
          return this.panels[this.lastAnchor][0].addEventListener(
            css.transitionEnd,
            onTransitionEnd,
            false
          );
    ...
    OriDomi.prototype._normalizeArgs = function (method, args) {
      ...
      if (
        ...
        (method === "foldUp" && this.lastAngle !== 0) ||
        this.isFoldedUp
      ) {
        this.reset(function () {
    ...
    OriDomi.prototype._setTweening = function (speed) {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        if (this.shading) {
          this.shaders[this.lastAnchor][shaderPair[0]][i].style[
            css.transitionDuration
          ] = speed;
          this.shaders[this.lastAnchor][shaderPair[1]][i].style[
            css.transitionDuration
          ] = speed;
        }
      }
    ...
    OriDomi.prototype._onTouchStart = function (e) {
      ...
      this._touchAxis =
        this.lastAnchor === "left" || this.lastAnchor === "right" ? "x" : "y";
      this["_" + this._touchAxis + "Last"] = this.lastAngle;
      if (e.type === "mousedown") {
        this["_" + this._touchAxis + "1"] =
          e["page" + this._touchAxis.toUpperCase()];
      } else {
        this["_" + this._touchAxis + "1"] =
      ...
      return this.settings.touchStartCallback(
        this["_" + this._touchAxis + "1"]
      );
    };
    ...
    OriDomi.prototype._onTouchEnd = function (e) {
      ...
      return this.settings.touchEndCallback(
    ...
    OriDomi.prototype.destroy = function (callback) {
      ...
      return this.freeze(function () {
        ...
        _this.stageEl.removeEventListener(
          "touchstart",
          _this._onTouchStart,
          false
        );
    ...
    OriDomi.prototype.foldUp = function (anchor, callback) {
      ...
      angle = 100;
      nextPanel = function () {
        _this.panels[anchor][i].addEventListener(
          css.transitionEnd,
          onTransitionEnd,
          false
        );
      ...
      onTransitionEnd = function (e) {
        _this.panels[anchor][i].removeEventListener(
          css.transitionEnd,
          onTransitionEnd,
          false
        );
    ...
    OriDomi.prototype.unfold = function (callback) {
      ...
      nextPanel = function () {
        ...
        return setTimeout(function () {
          _this.panels[_this.lastAnchor][i].addEventListener(
            css.transitionEnd,
            onTransitionEnd,
            false
          );
          _this.panels[_this.lastAnchor][i].style[
            css.transform
          ] = _this._transform(angle);
          if (_this.shading) {
      ...
      onTransitionEnd = function (e) {
        _this.panels[_this.lastAnchor][i].removeEventListener(
          css.transitionEnd,
          onTransitionEnd,
          false
        );
          ...
          if (instance == null) {
            if (devMode) {
              console.warn(
                "oriDomi: Can't call " +
                  options +
                  ", oriDomi hasn't been initialized on this element"
              );
            }
            return;
          }
